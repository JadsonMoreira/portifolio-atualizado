      ...
      <div className="grid md:grid-cols-5 gap-12">
        ...
        <div className="md:col-span-2 relative group max-w-[300px] mx-auto">
          ...
          <div className="relative bg-[var(--green)] rounded overflow-hidden">
            <img
              src="https://media.licdn.com/dms/image/v2/C5603AQGs5wGmhV3czg/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1629386427630?e=1783555200&v=beta&t=JyPWHjA2MO1TDpCXrZWxdNbSoFhoR7Lsai7LiBIdnLY"
              alt="Jadson"
